  ...
  "schema": {
    ...
    "$defs": {
      ...
      "elements": {
                ...
                "settings": {
                  ...
                  "properties": {
                    "url": {
                      ...
                      "description": "For images urls use this url as a placholder: https://placehold.co/600x400?text=Hello+World"
                    },
                    "_title": {
                      "type": "string",
                      "description": "A short description, up to 3 words"
              ...
              "properties": {
                ...
                "settings": {
                  ...
                  "properties": {
                    "text": {
                      "type": "string",
                      "description": "Button text, for example: 'Click me!'"
                    },
                    "_title": {
                      "type": "string",
                      "description": "A short description, up to 3 words"
                ...
                "settings": {
                  ...
                  "properties": {
                    "src": {
                        ...
                        "description": "For videos urls use this url as a placholder: https://storage.googleapis.com/gtv-videos-bucket/sample/ForBiggerMeltdowns.mp4"
                    },
                    "_title": {
                      "type": "string",
                      "description": "A short description, up to 3 words"
        ...
        "description": "The elements property must be an array even if it has only one item"
      }
    },
    "required": [
      "id",
